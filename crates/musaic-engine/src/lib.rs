...
use leptos_musaic::protocol::{CANVAS_KEY, FromWorker, MESSAGE_KEY, SelectedEntity, ToWorker};
...
fn touch_phase(phase: leptos_musaic::protocol::TouchPhase) -> TouchPhase {
    match phase {
        leptos_musaic::protocol::TouchPhase::Started => TouchPhase::Started,
        leptos_musaic::protocol::TouchPhase::Moved => TouchPhase::Moved,
        leptos_musaic::protocol::TouchPhase::Ended => TouchPhase::Ended,
        leptos_musaic::protocol::TouchPhase::Cancelled => TouchPhase::Cancelled,
    }
}
